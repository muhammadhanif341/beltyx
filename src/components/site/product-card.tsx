      ...
      <div className="relative aspect-square overflow-hidden bg-muted">
        ...
        <div className="absolute inset-x-0 top-0 flex items-start justify-between p-3">
          ...
          <button
            ...
            className="flex size-9 items-center justify-center rounded-full bg-background/80 backdrop-blur transition-colors hover:bg-background"
          >
            <Heart
              className={cn(
        ...
        <div className="absolute inset-x-3 bottom-3 translate-y-2 opacity-0 transition-all duration-300 group-hover/product:translate-y-0 group-hover/product:opacity-100">
          <Button variant="hero" size="lg" className="w-full" onClick={handleQuickAdd}>
